...
public class MemberResourceRESTService {
    ...
    public List<Member> listAllMembers() {
        return repository.findAllOrderedByPseudo();
    }
    ...
    private void validateMember(Member member) throws ConstraintViolationException, ValidationException {
        ...
        if (pseudoAlreadyExists(member.getPseudo())) {
            throw new ValidationException("Unique Pseudo Violation");
        }
    }
    ...
    public boolean pseudoAlreadyExists(String pseudo) {
        Member member = null;
        try {
            member = repository.findByPseudo(pseudo);
